Ext.define('AP.store.acquisitionUnit.CurveGroupHistoryInfoStore', {
    extend: 'Ext.data.Store',
    alias: 'widget.curveGroupHistoryInfoStore',
    autoLoad: true,
    ...
    listeners: {
        load: function (store, options, eOpts) {
            ...
            var gridPanel = Ext.getCmp("historyCurveGroupConfigGridPanel_Id");
            if (!isNotVal(gridPanel)) {
                gridPanel = Ext.create('Ext.grid.Panel', {
                    id: "historyCurveGroupConfigGridPanel_Id",
...
//                        }
                ...
                var panel = Ext.getCmp("historyCurveGroupConfigPanel_Id");
                if(isNotVal(panel)){
                	panel.add(gridPanel);
                }
            }
