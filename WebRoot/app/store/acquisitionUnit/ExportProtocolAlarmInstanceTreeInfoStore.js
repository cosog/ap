Ext.define('AP.store.acquisitionUnit.ExportProtocolAlarmInstanceTreeInfoStore', {
    extend: 'Ext.data.TreeStore',
    alias: 'widget.exportProtocolAlarmInstanceTreeInfoStore',
    ...
    proxy: {
        type: 'ajax',
        url: context + '/acquisitionUnitManagerController/exportProtocolAlarmInstanceTreeData',
        actionMethods: {
            read: 'POST'
        },
        reader: {
        ...
        load: function (store, options, eOpts) {
            ...
            if (!isNotVal(treeGridPanel)) {
                treeGridPanel = Ext.create('Ext.tree.Panel', {
                    id: "ExportProtocolAlarmInstanceTreeGridPanel_Id",
//                    layout: "fit",
                    border: false,
                    animate: true,
                    enableDD: false,
                ...
                var panel = Ext.getCmp("ProtocolExportAlarmInstancePanel_Id");
