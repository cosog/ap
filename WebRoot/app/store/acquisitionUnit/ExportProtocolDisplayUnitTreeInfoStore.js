Ext.define('AP.store.acquisitionUnit.ExportProtocolDisplayUnitTreeInfoStore', {
    extend: 'Ext.data.TreeStore',
    alias: 'widget.exportProtocolDisplayUnitTreeInfoStore',
    ...
    proxy: {
        type: 'ajax',
        url: context + '/acquisitionUnitManagerController/exportDisplayUnitTreeData',
        actionMethods: {
            read: 'POST'
        },
        reader: {
        ...
        load: function (store, options, eOpts) {
            ...
            if (!isNotVal(gridPanel)) {
                gridPanel = Ext.create('Ext.tree.Panel', {
                    id: "ExportProtocolDisplayUnitTreeGridPanel_Id",
//                    layout: "fit",
                    border: false,
                    animate: true,
                    enableDD: false,
