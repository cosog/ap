Ext.define('AP.store.acquisitionUnit.ModbusProtocolAcqInstanceProtocolTreeInfoStore', {
    extend: 'Ext.data.TreeStore',
    alias: 'widget.modbusProtocolAcqInstanceProtocolTreeInfoStore',
    ...
    listeners: {
        ...
        load: function (store, options, eOpts) {
        	var gridPanel = Ext.getCmp("AcqInstanceProtocolTreeGridPanel_Id");
            if (!isNotVal(gridPanel)) {
                gridPanel = Ext.create('Ext.tree.Panel', {
                    id: "AcqInstanceProtocolTreeGridPanel_Id",
                    border: false,
                    animate: true,
                    enableDD: false,
                    useArrows: false,
