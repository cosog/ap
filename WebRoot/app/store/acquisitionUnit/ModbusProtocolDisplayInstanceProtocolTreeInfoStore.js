Ext.define('AP.store.acquisitionUnit.ModbusProtocolDisplayInstanceProtocolTreeInfoStore', {
    extend: 'Ext.data.TreeStore',
    alias: 'widget.modbusProtocolDisplayInstanceProtocolTreeInfoStore',
    ...
    listeners: {
        ...
        load: function (store, options, eOpts) {
        	var gridPanel = Ext.getCmp("DisplayInstanceProtocolTreeGridPanel_Id");
            if (!isNotVal(gridPanel)) {
                gridPanel = Ext.create('Ext.tree.Panel', {
                    id: "DisplayInstanceProtocolTreeGridPanel_Id",
                    border: false,
                    animate: true,
                    enableDD: false,
                    useArrows: false,
                    ...
                    listeners: {
                        ...
                        select( v, record, index, eOpts ){
                        	Ext.getCmp("ModbusProtocolDisplayInstanceProtocolSelectRow_Id").setValue(index);
                ...
                var panel = Ext.getCmp("ModbusProtocolDisplayInstanceProtocolListPanel_Id");
                panel.add(gridPanel);
            }
            var selectedRow=parseInt(Ext.getCmp("ModbusProtocolDisplayInstanceProtocolSelectRow_Id").getValue());
            if(selectedRow==0){
