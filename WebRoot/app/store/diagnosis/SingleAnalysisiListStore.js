Ext.define('AP.store.diagnosis.SingleAnalysisiListStore', {
    ...
    fields: ['wellName','acqTime',
    	...
    	'liquidWeightProduction', 'oilWeightProduction', 'waterWeightProduction', 'volumeWaterCut', 
        ...
        'systemEfficiency', 'surfaceSystemEfficiency','welldownSystemEfficiency', 'averageWatt', 'polishrodPower', 'waterPower','energyPer100mLift', 
        'todayKWattH', 
