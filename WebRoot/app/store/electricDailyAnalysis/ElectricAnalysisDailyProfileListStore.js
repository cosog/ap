Ext.define('AP.store.electricDailyAnalysis.ElectricAnalysisDailyProfileListStore', {
    ...
    listeners: {
        load: function (store, sEops) {
            ...
            var column = createElecAnalysisDailyProfileTableColumn(arrColumns);
            var newColumns = Ext.JSON.decode(column);
            var gridPanel = Ext.getCmp("electricAanlysisDailyProfileTablePanel_Id");
            if (!isNotVal(gridPanel)) {
            	gridPanel= Ext.create('Ext.grid.Panel', {
                    id: 'electricAanlysisDailyProfileTablePanel_Id',
                    border: false,
    				columnLines: true,
    				forceFit: true,
    				store: store,
...
//            	gridPanel.reconfigure(newColumns);
        ...
        beforeload: function (store, options) {
            ...
            var type = getElectricAnalysisDailyProfileType();
            var new_params = {
            	orgId:orgId,
        		type:type
            };
