Ext.define('AP.store.historyQuery.RPCHistoryDataStore', {
    extend: 'Ext.data.Store',
    alias: 'widget.rpcHistoryDataStore',
    ...
    listeners: {
        load: function (store, record, f, op, o) {
            ...
            Ext.getCmp("RPCHistoryQueryDataColumnStr_Id").setValue(column);
            ...
            if (!isNotVal(gridPanel)) {
                ...
                gridPanel = Ext.create('Ext.grid.Panel', {
                    id: "RPCHistoryQueryDataGridPanel_Id",
                    border: false,
                    autoLoad: false,
                    bbar: bbar,
                    columnLines: true,
...
//                    		CreateRPCDeviceHistoryQueryDataTable(record.data.id,record.data.wellName);
                    	},
                    	select: function(grid, record, index, eOpts) {}
                    }
                });
                var panel = Ext.getCmp("RPCHistoryQueryDataInfoPanel_Id");
                panel.add(gridPanel);
            }
