Ext.define('AP.store.kafkaConfig.A9RawDataListStore', {
    ...
    proxy: {
    	type: 'ajax',
        url: context + '/kafkaConfigController/getA9RawDataList',
        actionMethods: {
            read: 'POST'
        },
        reader: {
                        ...
                        selectionchange: function (view, selected, o) {
                            if (selected.length > 0) {
                            	if(isNaN(selected[0].id)){
                            		$("#A9RawDataCurveChartDiv1_Id").html('');
                                	$("#A9RawDataCurveChartDiv2_Id").html('');
                                	$("#A9RawDataCurveChartDiv3_Id").html('');
                                	$("#A9RawDataCurveChartDiv4_Id").html('');
                                	$("#A9RawDataCurveChartDiv5_Id").html('');
                            	}else{
                            		//请求图形数据
