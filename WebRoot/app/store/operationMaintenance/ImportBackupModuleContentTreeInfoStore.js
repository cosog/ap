Ext.define('AP.store.operationMaintenance.ImportBackupModuleContentTreeInfoStore', {
    extend: 'Ext.data.TreeStore',
    alias: 'widget.importBackupModuleContentTreeInfoStore',
    ...
    listeners: {
        ...
        load: function (store, options, eOpts) {
            ...
            var treeGridPanel = Ext.getCmp("ImportBackupModuleContentTreeGridPanel_Id");
            if (!isNotVal(treeGridPanel)) {
                var treeGridPanel = Ext.create('Ext.tree.Panel', {
                    id: "ImportBackupModuleContentTreeGridPanel_Id",
                    border: false,
                    layout: "fit",
                    loadMask: true,
                    rootVisible: false,
