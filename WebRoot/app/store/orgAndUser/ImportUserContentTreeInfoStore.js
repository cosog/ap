Ext.define('AP.store.orgAndUser.ImportUserContentTreeInfoStore', {
    extend: 'Ext.data.Store',
    alias: 'widget.importUserContentTreeInfoStore',
    ...
    listeners: {
        ...
        load: function (store, options, eOpts) {
            ...
            var gridPanel = Ext.getCmp("ImportUserContentTreeGridPanel_Id");
            if (!isNotVal(gridPanel)) {
                var gridPanel = Ext.create('Ext.grid.Panel', {
                    id: "ImportUserContentTreeGridPanel_Id",
                    border: false,
                    stateful: true,
                    columnLines: true,
                    layout: "fit",
                    ...
                    columns: [{
                    	...
                    	renderer:function(value,o,p,e){
                    		return adviceImportUserCollisionInfoColor(value,o,p,e);
                    	}
                    }],
                    listeners: {
