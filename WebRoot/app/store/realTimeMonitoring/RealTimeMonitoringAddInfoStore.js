Ext.define('AP.store.realTimeMonitoring.RealTimeMonitoringAddInfoStore', {
    ...
    listeners: {
        load: function (store, record, f, op, o) {
        	if(Ext.getCmp("RealTimeMonitoringRightAuxiliaryDeviceInfoPanel")!=undefined){
        		...
        		if(!isNotVal(deviceInfoGridPanel)){
        			...
        			if(Ext.getCmp("RealTimeMonitoringRightDeviceAddInfoPanel")!=undefined){
        	...
        	if(isNotVal(Ext.getCmp("RealTimeMonitoringTabPanel"))){
                Ext.getCmp("RealTimeMonitoringTabPanel").getEl().unmask();
            }
            if(isNotVal(Ext.getCmp("RealTimeMonitoringInfoPanel_Id"))){
