...
//    minimizable: true,
    ...
    initComponent: function () {
        ...
        Ext.apply(me, {
            layout: "border",
            id: 'DatabaseColumnMappingWindowPanel_Id',
            items: [{
            	region: 'west',
            	width:'20%',
            	layout: 'fit',
            ...
            listeners: {
                ...
                maximize: function (win) {
                    ...
                    var panel = Ext.getCmp('DatabaseColumnMappingWindowPanel_Id');
                    if (panel) {
                ...
                afterrender: function (panel) {
                    ...
                    win._panel = win.down('#DatabaseColumnMappingWindowPanel_Id');
			...
			if(stopValueSelection.length>0){
				for(var i=0;i<stopValueSelection.length;i++){
					if(isNumber(stopValueSelection[i].data.value)){
						var sign="";
						if(stopValueSelection[i].data.id==1){
							sign=">";
						}else if(stopValueSelection[i].data.id==2){
							sign=">=";
						}else if(stopValueSelection[i].data.id==3){
							sign="<=";
						}else if(stopValueSelection[i].data.id==4){
							sign="<";
						}
