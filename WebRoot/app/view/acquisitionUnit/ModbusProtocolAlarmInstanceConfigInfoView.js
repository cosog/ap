		...
		createNew: function (divid) {
	        ...
	        protocolAlarmInstanceConfigNumItemsHandsontableHelper.createTable = function (data) {
	        	...
	        	protocolAlarmInstanceConfigNumItemsHandsontableHelper.hot = new Handsontable(hotElement, {
	        		licenseKey: '96860-f3be6-b4941-2bd32-fd62b',
	        		data: data,
	        		colWidths: [50,120,80,80,80,80,100,100,80,80,90,90],
	...
	Ext.Ajax.request({
		...
		success:function(response) {
			...
			if(protocolAlarmInstanceConfigCalNumItemsHandsontableHelper==null || protocolAlarmInstanceConfigCalNumItemsHandsontableHelper.hot==undefined){
				...
				var colHeaders="['"+loginUserLanguageResource.idx+"','"+loginUserLanguageResource.name+"','"+loginUserLanguageResource.unit+"','上限','下限','回差','延时持续检测(s)','再次触发间隔(s)','"+loginUserLanguageResource.alarmLevel+"','报警使能','"+loginUserLanguageResource.isSendMessage+"','"+loginUserLanguageResource.isSendEmail+"']";
				var columns="[{data:'id'},{data:'title'},"
					 	+"{data:'unit'},"
						+"{data:'upperLimit'},"
						+"{data:'lowerLimit'}," 
	...
	Ext.Ajax.request({
		...
		success:function(response) {
			...
			if(protocolAlarmInstanceConfigSwitchItemsHandsontableHelper==null || protocolAlarmInstanceConfigSwitchItemsHandsontableHelper.hot==undefined){
				...
				var colHeaders="['"+loginUserLanguageResource.idx+"','"+loginUserLanguageResource.name+"','地址','"+loginUserLanguageResource.bit+"','"+loginUserLanguageResource.meaning+"','触发状态','延时持续检测(s)','再次触发间隔(s)','"+loginUserLanguageResource.alarmLevel+"','报警使能','"+loginUserLanguageResource.isSendMessage+"','"+loginUserLanguageResource.isSendEmail+"']";
				var columns="[{data:'id'},{data:'title'},"
					 	+"{data:'addr'},"
						+"{data:'bitIndex'},"
						+"{data:'meaning'}," 
	...
	Ext.Ajax.request({
		...
		success:function(response) {
			...
			if(protocolAlarmInstanceConfigEnumItemsHandsontableHelper==null || protocolAlarmInstanceConfigEnumItemsHandsontableHelper.hot==undefined){
				...
				var colHeaders="['"+loginUserLanguageResource.idx+"','"+loginUserLanguageResource.name+"','地址','值','"+loginUserLanguageResource.meaning+"','延时持续检测(s)','再次触发间隔(s)','"+loginUserLanguageResource.alarmLevel+"','报警使能','"+loginUserLanguageResource.isSendMessage+"','"+loginUserLanguageResource.isSendEmail+"']";
				var columns="[{data:'id'},{data:'title'},"
					 	+"{data:'addr'},"
					 	+"{data:'value'}," 
						+"{data:'meaning'},"
		...
		createNew: function (divid) {
	        ...
	        protocolAlarmInstanceConfigEnumItemsHandsontableHelper.createTable = function (data) {
	        	...
	        	protocolAlarmInstanceConfigEnumItemsHandsontableHelper.hot = new Handsontable(hotElement, {
	        		licenseKey: '96860-f3be6-b4941-2bd32-fd62b',
	        		data: data,
	        		colWidths: [50,120,80,80,80,100,100,80,80,90,90],
	...
	Ext.Ajax.request({
		...
		success:function(response) {
			...
			if(protocolAlarmInstanceConfigFESDiagramResultItemsHandsontableHelper==null || protocolAlarmInstanceConfigFESDiagramResultItemsHandsontableHelper.hot==undefined){
				...
				var colHeaders="['"+loginUserLanguageResource.idx+"','"+loginUserLanguageResource.name+"','延时持续检测(s)','再次触发间隔(s)','"+loginUserLanguageResource.alarmLevel+"','报警使能','"+loginUserLanguageResource.isSendMessage+"','"+loginUserLanguageResource.isSendEmail+"']";
				var columns="[{data:'id'},{data:'title'},"
		...
		createNew: function (divid) {
	        ...
	        protocolAlarmInstanceConfigFESDiagramResultItemsHandsontableHelper.createTable = function (data) {
	        	...
	        	protocolAlarmInstanceConfigFESDiagramResultItemsHandsontableHelper.hot = new Handsontable(hotElement, {
	        		licenseKey: '96860-f3be6-b4941-2bd32-fd62b',
	        		data: data,
	        		colWidths: [50,80,100,100,80,80,80,80],
