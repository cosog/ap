...
//                iconCls: 'save',
            ...
            layout: 'border',
            id:"ReportUnitContentConfigWindowPanel_Id",
            items: [{
            	region: 'west',
            	width:'30%',
            ...
            listeners: {
                ...
                maximize: function (win) {
                    ...
                    var panel = Ext.getCmp('ReportUnitContentConfigWindowPanel_Id');
                    if (panel) {
                ...
                afterrender: function (panel) {
                    ...
                    win._panel = win.down('#ReportUnitContentConfigWindowPanel_Id');
