Ext.define('AP.view.alarmQuery.RPCSwitchingValueAlarmInfoView', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.RPCSwitchingValueAlarmInfoView',
    layout: "fit",
    id: "RPCSwitchingValueAlarmInfoView_Id",
    border: false,
    //forceFit : true,
    initComponent: function () {
        var deviceCombStore = new Ext.data.JsonStore({
            ...
            listeners: {
                beforeload: function (store, options) {
                    ...
                    var wellName = Ext.getCmp('RPCSwitchingValueAlarmDeviceListComb_Id').getValue();
                    var deviceType = 0;
                    var new_params = {
                        orgId: leftOrg_Id,
        ...
        var deviceCombo = Ext.create(
                'Ext.form.field.ComboBox', {
                    fieldLabel: '井名',
                    id: "RPCSwitchingValueAlarmDeviceListComb_Id",
                    labelWidth: 35,
                    width: 145,
                    labelAlign: 'left',
                    queryMode: 'remote',
    	...
    	Ext.apply(this, {
    		layout: 'border',
    		tbar: [{
                id: 'RPCSwitchingValueAlarmOverviewColumnStr_Id',
                xtype: 'textfield',
                value: '',
                hidden: true
            },{
                id: 'RPCSwitchingValueAlarmDetailsColumnStr_Id',
                xtype: 'textfield',
                value: '',
                hidden: true
            },deviceCombo,'-',{
                ...
                format: 'Y-m-d ',
                value: '',
                id: 'RPCSwitchingValueAlarmQueryStartDate_Id',
                listeners: {
                	select: function (combo, record, index) {
                    }
                }
            	...
            	xtype: 'numberfield',
            	id: 'RPCSwitchingValueAlarmQueryStartTime_Hour_Id',
                fieldLabel: '时',
                labelWidth: 15,
                width: 60,
                minValue: 0,
            	...
            	xtype: 'numberfield',
            	id: 'RPCSwitchingValueAlarmQueryStartTime_Minute_Id',
                fieldLabel: '分',
                labelWidth: 15,
                width: 60,
                minValue: 0,
            	...
            	xtype: 'numberfield',
            	id: 'RPCSwitchingValueAlarmQueryStartTime_Second_Id',
                fieldLabel: '秒',
                labelWidth: 15,
                width: 60,
                minValue: 0,
                ...
                format: 'Y-m-d ',
                value: '',
                id: 'RPCSwitchingValueAlarmQueryEndDate_Id',
                listeners: {
                	select: function (combo, record, index) {
                    }
                }
            	...
            	xtype: 'numberfield',
            	id: 'RPCSwitchingValueAlarmQueryEndTime_Hour_Id',
                fieldLabel: '时',
                labelWidth: 15,
                width: 60,
                minValue: 0,
            	...
            	xtype: 'numberfield',
            	id: 'RPCSwitchingValueAlarmQueryEndTime_Minute_Id',
                fieldLabel: '分',
                labelWidth: 15,
                width: 60,
                minValue: 0,
            	...
            	xtype: 'numberfield',
            	id: 'RPCSwitchingValueAlarmQueryEndTime_Second_Id',
                fieldLabel: '秒',
                labelWidth: 15,
                width: 60,
                minValue: 0,
                ...
                handler: function () {
                	...
                	if(!r.test(startTime_Hour)){
                		Ext.Msg.alert('消息', "<font color=red>数值无效！</font>小时为0~23之间的整数。");
                		Ext.getCmp('RPCSwitchingValueAlarmQueryStartTime_Hour_Id').focus(true, 100);
                		return;
                	}
                	var startTime_Minute=Ext.getCmp('RPCSwitchingValueAlarmQueryStartTime_Minute_Id').getValue();
                	if(!r2.test(startTime_Minute)){
                		Ext.Msg.alert('消息', "<font color=red>数值无效！</font>分钟为0~59之间的整数。");
                		Ext.getCmp('RPCSwitchingValueAlarmQueryStartTime_Minute_Id').focus(true, 100);
                		return;
                	}
                	var startTime_Second=Ext.getCmp('RPCSwitchingValueAlarmQueryStartTime_Second_Id').getValue();
                	if(!r2.test(startTime_Second)){
                		Ext.Msg.alert('消息', "<font color=red>数值无效！</font>秒为0~59之间的整数。");
                		Ext.getCmp('RPCSwitchingValueAlarmQueryStartTime_Second_Id').focus(true, 100);
                		return;
                	}
                	...
                	if(!r.test(endTime_Hour)){
                		Ext.Msg.alert('消息', "<font color=red>数值无效！</font>小时为0~23之间的整数。");
                		Ext.getCmp('RPCSwitchingValueAlarmQueryEndTime_Hour_Id').focus(true, 100);
                		return;
                	}
                	var endTime_Minute=Ext.getCmp('RPCSwitchingValueAlarmQueryEndTime_Minute_Id').getValue();
                	if(!r2.test(endTime_Minute)){
                		Ext.Msg.alert('消息', "<font color=red>数值无效！</font>分钟为0~59之间的整数。");
                		Ext.getCmp('RPCSwitchingValueAlarmQueryEndTime_Minute_Id').focus(true, 100);
                		return;
                	}
                	var endTime_Second=Ext.getCmp('RPCSwitchingValueAlarmQueryEndTime_Second_Id').getValue();
                	if(!r2.test(endTime_Second)){
                		Ext.Msg.alert('消息', "<font color=red>数值无效！</font>秒为0~59之间的整数。");
                		Ext.getCmp('RPCSwitchingValueAlarmQueryEndTime_Second_Id').focus(true, 100);
                		return;
                	}
                ...
                handler: function (v, o) {
                	...
                	var orgId = Ext.getCmp('leftOrg_Id').getValue();
                	var deviceType=0;
                	var deviceId  =   Ext.getCmp("RPCSwitchingValueAlarmOverviewGridPanel_Id").getSelectionModel().getSelection()[0].data.id;
                	var deviceName  = Ext.getCmp("RPCSwitchingValueAlarmOverviewGridPanel_Id").getSelectionModel().getSelection()[0].data.wellName;
                	var alarmLevel=Ext.getCmp('RPCSwitchingValueAlarmLevelComb_Id').getValue();
                	var isSendMessage=Ext.getCmp('RPCSwitchingValueAlarmIsSendMessageComb_Id').getValue();
