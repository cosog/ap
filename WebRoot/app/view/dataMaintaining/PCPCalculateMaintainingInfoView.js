...
//            afterPageText: "共{0}页",
        ...
        var calculateSignComb = Ext.create(
                'Ext.form.field.ComboBox', {
                    ...
                    labelWidth: getLabelWidth(loginUserLanguageResource.resultStatus,loginUserLanguage),
                    width: (getLabelWidth(loginUserLanguageResource.resultStatus,loginUserLanguage)+100),
...
function ReTotalRPMData(){
    ...
    if (_record.length>0) {
    	...
    	if(Ext.getCmp("PCPTotalCalculateMaintainingPanel")!=undefined){
