...
//			
			...
			if(result.positionCurveData!=undefined && result.positionCurveData!="" && result.positionCurveData.split(",").length>0){
				showFSDiagramWithAtrokeSPM(result,"electricAnalysisRealtimeCurveCheckInverDiv1_id");
				showFSDiagram360WithAtrokeSPM(result,"electricAnalysisRealtimeCurveCheckInverDiv2_id");
