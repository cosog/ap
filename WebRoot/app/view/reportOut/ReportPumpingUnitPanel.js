...
var DiagnoseDailyReportHelper = {
	    ...
	    ['', '', '','在线时间(h)','在线区间', '在线时率(小数)','运行时间(h)','运行区间', '运行时率(小数)','功图工况','优化建议','产液量（t/d）', '产油量（t/d）','产水量（t/d）', '含水率(%)','充满系数(小数)','功率平衡状态','功率平衡度(%)','电流平衡状态','电流平衡度(%)','移动距离', '系统效率(%)', '地面效率(%)', '井下效率(%)','吨液百米耗电量(kW·h/100·t)','',''],
	    ['合计', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''],
	    ['平均', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '']
	  ];
...
//	                fixedColumnsLeft:1, //固定左侧多少列不能水平滚动
	                ...
	                colHeaders: false,
					rowHeights: [50],
					colWidths:[50,90,75, 80,100,70, 80,100,70, 120,120, 80,80,80,80,80, 80,80,80,80,80,  80,80,80,120, 80, 75],
					stretchH: 'all',
	                mergeCells: [
	                    {
	                        "row": 0,
