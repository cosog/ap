        ...
        Ext.apply(me, {
            tbar: [wellListCombo, {
                ...
                handler: function (v, o) {
                	...
                	var url=context + '/reportPumpingUnitDataController/exportScrewPumpDailyReportExcelData?wellType=400&wellName='+URLencode(URLencode(wellName))+'&calculateDate='+calculateDate+'&orgId='+leftOrg_Id;
