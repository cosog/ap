...
Ext.define('AP.view.well.WellResTreeComboBox', {
    extend: 'Ext.form.field.ComboBox',
    alias: 'widget.wellResTreeComboBox',
    ...
    initComponent: function () {
        ...
        treeObj.on('itemclick', function (view, rec) {
            if (rec) {
                ...
                combo._idValue = rec.data.resCode;
                //设置回调  
                combo.callback.call(this, rec.data.resCode, rec.get('text'));
                combo.collapse();
            }
        });
