...
/
alter table TBL_RPCTIMINGCALCULATIONDATA  add constraint PK_RPCTIMINGALCULATIONDATA primary key (ID)
/
...
/
alter table TBL_PCPTIMINGCALCULATIONDATA  add constraint PK_PCPTIMINGCALCULATIONDATA primary key (ID)
/
