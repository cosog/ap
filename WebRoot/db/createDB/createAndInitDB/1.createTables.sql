...
(
  ...
  c_qtkz                         VARCHAR2(4000),
  c_dym                          VARCHAR2(4000),
  c_cc                           VARCHAR2(4000),
  c_mcdbs                        VARCHAR2(4000),
  c_yljazsd                      VARCHAR2(4000),
  c_jxyljyl                      VARCHAR2(4000),
  c_jkty                         VARCHAR2(4000),
  c_xtyl                         VARCHAR2(4000),
  c_cqllj                        VARCHAR2(4000),
  c_cqlss                        VARCHAR2(4000),
  c_qtwd                         VARCHAR2(4000),
  c_csllj                        VARCHAR2(4000),
  c_cslss                        VARCHAR2(4000),
  c_jxyljwd                      VARCHAR2(4000),
  c_qtlljtxzt                    VARCHAR2(4000),
  c_slljtxzt                     VARCHAR2(4000),
  c_jxyljymytxzt                 VARCHAR2(4000),
  c_bpqtxzt                      VARCHAR2(4000),
  c_plkzfs                       VARCHAR2(4000),
  c_bpqszpl                      VARCHAR2(4000),
  c_bpqyxpl                      VARCHAR2(4000),
  c_bpqgzzt                      VARCHAR2(4000),
  c_bpqscdl                      VARCHAR2(4000),
  c_bpqscdy                      VARCHAR2(4000),
  c_bpqcjdm                      VARCHAR2(4000),
  c_bpqztz1                      VARCHAR2(4000),
  c_bpqztz2                      VARCHAR2(4000),
  c_bdxnwz                       VARCHAR2(4000),
  c_mxdy                         VARCHAR2(4000),
  c_sdplfk                       VARCHAR2(4000),
  c_10hzdycczsysz                VARCHAR2(4000),
  c_50hzdycczsysz                VARCHAR2(4000),
  c_cczssdz                      VARCHAR2(4000),
  c_xzhjdly                      VARCHAR2(4000),
  c_jsyzgd                       VARCHAR2(4000),
  c_jsj1xsyzxjsd                 VARCHAR2(4000),
  c_pcms                         VARCHAR2(4000),
  c_zdpczt                       VARCHAR2(4000),
  c_zdpczxpl                     VARCHAR2(4000),
  c_zdpczdpl                     VARCHAR2(4000),
  c_zdbcfdxz                     VARCHAR2(4000),
  c_zddzsjjg                     VARCHAR2(4000),
  c_zdzqys                       VARCHAR2(4000),
  c_zdzqcs                       VARCHAR2(4000),
  c_jdlybdbjz                    VARCHAR2(4000),
  c_djymbdjmr                    VARCHAR2(4000),
  c_djyyzdtjz                    VARCHAR2(4000),
  c_djyyzdbjz                    VARCHAR2(4000),
  c_djyyzzqz                     VARCHAR2(4000),
  c_djyyzgbjz                    VARCHAR2(4000),
  c_djypcs                       VARCHAR2(4000),
  c_djyics                       VARCHAR2(4000),
  c_djydcs                       VARCHAR2(4000),
  c_dlymbly                      VARCHAR2(4000),
  c_dlylydtjz                    VARCHAR2(4000),
  c_dlylydbjz                    VARCHAR2(4000),
  c_dlylyzqz                     VARCHAR2(4000),
  c_dlylygbjz                    VARCHAR2(4000),
  c_dlypcs                       VARCHAR2(4000),
  c_dlyics                       VARCHAR2(4000),
  c_dlydcs                       VARCHAR2(4000)
)
tablespace AP_DATA
  storage
  (
