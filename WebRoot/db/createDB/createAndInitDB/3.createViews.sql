...
select t2.id,t2.deviceid,t.devicename,t.devicetype,t3.itemname as deviceTypeName,t.signinid,t.slave,t2.acqtime,t2.rawdata,t.orgid,t4.allpath
from tbl_device t,tbl_acqrawdata t2,tbl_code t3,viw_org t4
...
t.devicetype,t4.name as deviceTypeName,
...
t2.recoverytime,t.orgid
 from tbl_device t,tbl_alarminfo_hist t2 ,tbl_code t3,
...
t2.issendmessage,t2.issendmail,
t2.recoverytime,t.orgid
 from tbl_device t,tbl_alarminfo_latest t2 ,tbl_code t3,tbl_devicetypeinfo t4,tbl_code t5
 where t2.deviceid=t.id
 and t3.itemcode='BJJB' and t3.itemvalue=t2.alarmlevel
 and t4.id=t.devicetype
 and t5.itemcode='alarmType' and t5.itemvalue=t2.alarmtype;
...
select t.id,t.parentid,t.sortnum,t.name,
substr(sys_connect_by_path(t.name,'/'),2) as allpath
...
t.devicename,
t.devicetype,t10.name as devicetypename,t10.allpath as deviceTypeAllPath,
t.calculatetype,
...
left outer join tbl_devicetypeinfo tab on t.devicetype=tab.id
...
select t.role_id,t.role_name,t.role_level,t.showlevel,t.role_videokeyedit,t.remark,
...
group by t.role_id,t.role_name,t.role_level,t.showlevel,t.role_videokeyedit,t.remark;
/

/*==============================================================*/
/* View: viw_rpcacqdata_hist                                         */
/*==============================================================*/
create or replace force view viw_rpcacqdata_hist as
select t.deviceid,device.orgid,device.calculatetype,
t.id,t.acqtime,
t.commstatus,t.commtime,t.commtimeefficiency,t.commrange,
t.runstatus,t.runtime,t.runtimeefficiency,t.runrange,
...
t.pumpintakep,t.pumpintaket,t.pumpintakegol,t.pumpintakevisl,t.pumpintakebo,
t.pumpoutletp,t.pumpoutlett,t.pumpoutletgol,t.pumpoutletvisl,t.pumpoutletbo
from tbl_device device,tbl_rpcacqdata_hist t,tbl_rpc_worktype t2
where device.id=t.deviceid and t.resultcode=t2.resultcode and device.calculatetype=1;
/
...
tbl_device device
left outer join  tbl_org org  on device.orgid=org.org_id
left outer join  tbl_rpcdailycalculationdata t  on t.deviceid=device.id
...
/*==============================================================*/
/* View: viw_rpctimingcalculationdata                                         */
/*==============================================================*/
create or replace force view viw_rpctimingcalculationdata as
select
 t.id,device.devicename,device.id as deviceid,device.devicetype,
 t.calTime,t.extendeddays,t.calTime-t.extendeddays as acquisitionDate,
 t.commstatus,decode(t.commstatus,1,'在线','离线') as commStatusName,t.commtime,t.commtimeefficiency,t.commrange,
 ...
 t.reservedcol1,t.reservedcol2,t.reservedcol3,t.reservedcol4,t.reservedcol5
from
tbl_device device,tbl_org org,tbl_rpctimingcalculationdata t,tbl_rpc_worktype status
where device.orgid=org.org_id and t.deviceid=device.id
and status.resultcode=decode(t.resultcode,null,1100,0,1100,t.resultcode)
and device.calculatetype=1;
/
...
t.loginip,t.action,
t3.itemname as actionname,t.remark ,t2.user_orgid as orgid
from tbl_systemlog t,tbl_user t2,tbl_code t3,viw_role t4
