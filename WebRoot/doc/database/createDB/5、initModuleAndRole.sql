...
insert into tbl_module (MD_ID, MD_PARENTID, MD_NAME, MD_SHOWNAME, MD_URL, MD_CODE, MD_SEQ, MD_LEVEL, MD_FLAG, MD_ICON, MD_TYPE, MD_CONTROL)
values (1958, 9999, '网关测调', '网关测调', '#', 'a9DeviceTest_Root', 10200, null, null, 'DeviceDebugging', 0, '#');

insert into tbl_module (MD_ID, MD_PARENTID, MD_NAME, MD_SHOWNAME, MD_URL, MD_CODE, MD_SEQ, MD_LEVEL, MD_FLAG, MD_ICON, MD_TYPE, MD_CONTROL)
values (1938, 1958, '命令下行', '命令下行', 'AP.view.kafkaConfig.KafkaConfigInfoView', 'kafkaConfig_kafkaConfigGridPanel', 1020010, null, null, 'Downstream', 0, '#');

insert into tbl_module (MD_ID, MD_PARENTID, MD_NAME, MD_SHOWNAME, MD_URL, MD_CODE, MD_SEQ, MD_LEVEL, MD_FLAG, MD_ICON, MD_TYPE, MD_CONTROL)
values (1959, 1958, '原始数据', '原始数据', 'AP.view.kafkaConfig.A9RawDataInfoView', 'kafkaConfig_A9RawDataGridPanel', 1020020, null, null, 'RawData', 0, '#');
...
values ('systemRole', '系统管理', 1, 141, '具有最大权限');

insert into TBL_ROLE (ROLE_CODE, ROLE_NAME, ROLE_FLAG, ROLE_ID, REMARK)
values ('adminRole', '软件管理员', 1, 302, '功图软件数据查询、数据编辑、权限管理权限');

insert into TBL_ROLE (ROLE_CODE, ROLE_NAME, ROLE_FLAG, ROLE_ID, REMARK)
values ('appRole', '应用分析员', 0, 322, '功图软件数据查询权限');
