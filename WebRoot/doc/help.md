...
![](../images/helpdoc/PNG/ece29499f083fc6704fa4feeb07f5815.png)
...
ad -o file输出打印信息到文件，同目录下生成ad\_log.txt

ad -o file+stdout 输出打印信息到屏幕和文件，同目录下生成ad_log.txt
...
![](../images/helpdoc/PNG/17e65fd9b8b6c469bb3e9eb3bc338372.png)
...
![](../images/helpdoc/PNG/2a7577d6a1d0d8a304d8f117c901d313.png)
...
![](../images/helpdoc/PNG/64b92d9d39eaf550f4b5b8e153590970.png)
...
单包发送间隔(ms)：读取RTU数据时，数据包发送间隔；

排序：实例排序序号，对应树形列表中实例显示顺序。

![](../images/helpdoc/PNG/85c8b5b0919113cbfbfeb1c86afc49bd.png)
...
当设备下行通信状态在线时，可进行下行数据操作。

![](../images/helpdoc/PNG/58ad1cfe0c730e129aca1f2904bcfc1b.png)
