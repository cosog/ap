...
- [第二章 应用介绍](#第二章应用介绍) 
    ...
    - [2.6 权限管理](#2.6权限管理)
      ...
      - [2.6.3 角色管理](#2.6.3角色管理)  
    - [2.7 数据配置](#2.7数据配置)  
      - [2.7.1 井名信息](#2.7.1井名信息)  
      - [2.7.2 生产数据](#2.7.2生产数据)  
      - [2.7.3 驱动配置](#2.7.3驱动配置)  
      - [2.7.4 计算维护](#2.7.4计算维护) 
    - [2.8 系统配置](#2.8系统配置)  
...
<h2><a name="1.3工况介绍"></a>1.3 工况介绍</h2>  
...
![列表伸缩](../images/helpdoc/GIF/001.gif?t=202005140953&raw=true)
...
![统计](../images/helpdoc/PNG/004.png?t=202005140953&raw=true)
...
![目标井](../images/helpdoc/PNG/005.png?t=202005140953&raw=true)

<h3><a name="2.2.3单井数据"></a>2.2.3 单井数据</h3>

&emsp;&emsp;包括图形及分析、采集、控制。

![单井数据](../images/helpdoc/PNG/006.png?t=202005140953&raw=true)
...
![地面功图](../images/helpdoc/PNG/027.png?t=202005140953&raw=true) 
...
![泵功图](../images/helpdoc/PNG/028.png?t=202005140953&raw=true)
...
![杆柱应力图](../images/helpdoc/PNG/029.png?t=202005140953&raw=true)

**4. 泵效组成**  
&emsp;&emsp;泵的实际排量与泵的理论排量之比的百分数称为泵效。

![泵效组成图](../images/helpdoc/PNG/030.png?t=202005140953&raw=true)

**5. 电流平衡度**

&emsp;&emsp;电流平衡度计算：  
&emsp;&emsp;电流平衡度=下冲程电流最大值/上冲程电流最大值  
![电流图](../images/helpdoc/PNG/031.png?t=202005140953&raw=true)

**6. 功率平衡度**

&emsp;&emsp;电功图是电的有功功率图，功率平衡度计算：  
&emsp;&emsp;功率平衡度=下冲程有功功率最大值/上冲程有功功率最大值  
![电功图](../images/helpdoc/PNG/032.png?t=202005140953&raw=true)

#### 2.2.3.2分析

&emsp;&emsp;显示计算分析结果参数及曲线，包括产量构成、泵效、系统效率、泵出入口参数等。

![分析](../images/helpdoc/PNG/007.png?t=202005140953&raw=true)

#### 2.2.3.3采集

&emsp;&emsp;显示传感器采集数据及曲线，包括通信状态、运行状态、油（套）压、电参数等。

![采集](../images/helpdoc/PNG/008.png?t=202005140953&raw=true)

#### 2.2.3.4控制

&emsp;&emsp;（1）井场监控视频显示及设备控制；  

![井场监控](../images/helpdoc/PNG/009.png?t=202005140953&raw=true)  

&emsp;&emsp;（2）**支持数字化抽油机平衡控制和频率控制**。  

![数字抽油机](../images/helpdoc/PNG/035.png?t=202005140953&raw=true)

<h2><a name="2.3全天评价"></a>2.3 全天评价</h2>

&emsp;&emsp;根据全天的采集数据与分析结果对单井进行全天评价。

![统计](../images/helpdoc/PNG/010.png?t=202005140953&raw=true)  

![目标井](../images/helpdoc/PNG/011.png?t=202005140953&raw=true)

<h2><a name="2.4生产报表"></a>2.4 生产报表</h2>

![生产报表](../images/helpdoc/PNG/013.png?t=202005140953&raw=true)

<h2><a name="2.5图形查询"></a>2.5 图形查询</h2>

&emsp;&emsp;默认显示所有井最新地面功图，选择某一口井显示该井历史地面功图。

![图形查询](../images/helpdoc/PNG/014.png?t=202005140953&raw=true)
...
3、 点击![创建按钮](../images/helpdoc/PNG/015.png?t=202005140953&raw=true)，创建模拟油田公司；填写完成后，点击![保存按钮](../images/helpdoc/PNG/016.png?t=202005140953&raw=true)，完成创建。  
...
4、 点击![创建按钮](../images/helpdoc/PNG/015.png?t=202005140953&raw=true)，创建模拟采油厂；填写完成后，点击![保存按钮](../images/helpdoc/PNG/016.png?t=202005140953&raw=true)，完成创建。  
...
![创建模拟油田公司](../images/helpdoc/GIF/002.gif?t=202005140953&raw=true)  

![创建模拟采油厂](../images/helpdoc/GIF/003.gif?t=202005140953&raw=true)
...
![创建用户](../images/helpdoc/GIF/004.gif?t=202005140953&raw=true)

<h3><a name="2.6.3角色管理"></a>2.6.3 角色管理</h3>
...
![创建用户](../images/helpdoc/PNG/034.png?t=202005140953&raw=true)
...
>- 采集类型：根据该井的实际采集控制数据，选择驱动配置模块中创建的类型；  
...
![井名信息录入](../images/helpdoc/GIF/005.gif?t=202005140953&raw=true)
...
![修改井名](../images/helpdoc/GIF/006.gif?t=202005140953&raw=true)

#### 2.7.1.4删除数据

&emsp;&emsp;选中一行或多行，右键，选择删除行，然后点击![保存按钮](../images/helpdoc/PNG/033.png?t=202005140953&raw=true)。

![删除数据](../images/helpdoc/GIF/007.gif?t=202005140953&raw=true)
...
![生产数据录入](../images/helpdoc/GIF/008.gif?t=202005140953&raw=true)

<h3><a name="2.7.3驱动配置"></a>2.7.3 驱动配置</h3>
...
&emsp;&emsp;点击![创建按钮](../images/helpdoc/PNG/015.png?t=202005140953&raw=true)创建采控类型，如类型名称“类型一”，类型编码“type1”，类型描述“抽油机全部数据”，创建完成后，在右侧列表中勾选实际采集项和控制项，点击![保存按钮](../images/helpdoc/PNG/033.png?t=202005140953&raw=true)完成配置。后续在**井名信息**模块数据录入时按照单井实际采控项选择不同的采控类型。

![采控配置](../images/helpdoc/PNG/017.png?t=202005140953&raw=true)

<h3><a name="2.7.4计算维护"></a>2.7.4 计算维护</h3>
...
![修改数据计算](../images/helpdoc/PNG/018.png?t=202005140953&raw=true)
...
![单井关联数据计算](../images/helpdoc/PNG/019.png?t=202005140953&raw=true)
...
![所有井关联数据计算](../images/helpdoc/PNG/020.png?t=202005140953&raw=true)
...
![字典配置](../images/helpdoc/PNG/022.png?t=202005140953&raw=true)

<h3><a name="2.8.2统计配置"></a>2.8.2 统计配置</h3>

&emsp;&emsp;配置各项参数的统计级别。

![统计配置](../images/helpdoc/PNG/023.png?t=202005140953&raw=true)

<h3><a name="2.8.3报警配置"></a>2.8.3 报警配置</h3>

&emsp;&emsp;设置工况类型的报警类型、报警项、级别、开关、颜色等。

![报警配置](../images/helpdoc/PNG/024.png?t=202005140953&raw=true)