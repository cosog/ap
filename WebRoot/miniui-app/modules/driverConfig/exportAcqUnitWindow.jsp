...
<script>
    ...
    function setData(data) {
        ...
        if (tree) {
            tree.load(context + '/acquisitionUnitManagerController/exportAcqUnitTreeData');
        }
    }
    ...
    function initI18n() {
        document.title = _loginUserLanguageResource.exportAcqUnit;
    ...
    function onExport() {
        ...
        var key = 'exportAcqUnitData_' + timestamp;
        var url = context + '/acquisitionUnitManagerController/exportProtocolAcqUnitData?key=' + key + '&unitList=' + unitList.join(',');

        exportDataMask(key, document.body, _loginUserLanguageResource.loadingData || '导出中...');
        openExcelWindow(url);
    }
