...
<script>
    ...
    function setData(data) {
        ...
        if (tree) {
            tree.load(context + '/acquisitionUnitManagerController/exportProtocolAlarmInstanceTreeData');
        }
    }
    ...
    function initI18n() {
        document.title = _loginUserLanguageResource.exportAlarmInstance;
    ...
    function onExport() {
        ...
        var key = 'exportProtocolAlarmInstanceData_' + timestamp;
        var url = context + '/acquisitionUnitManagerController/exportProtocolAlarmInstanceData'
