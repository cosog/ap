...
<div class="main-container">
    <div class="mini-toolbar">
        ...
        <form id="uploadForm"
              action="<%=context%>/acquisitionUnitManagerController/uploadImportedAlarmInstanceFile"
...
<script>
    ...
    function initI18n() {
        document.title = _loginUserLanguageResource.importAlarmInstance;
    ...
    function setData(data) {
        ...
        //var tree = mini.get('instanceTree');
        //if (tree) {
        //    tree.load(context + '/acquisitionUnitManagerController/getUploadedAlarmInstanceTreeData');
        //}
    }
    ...
    function onTreeLoad(e) {
        var tree = e.sender;
        tree.setColumns([
            { field: 'text', name: 'taskname', header: _loginUserLanguageResource.importAlarmInstance,
    ...
    function onTreeDrawcell(e) {
        ...
        if (field === 'msg' && record.classes == 1) {
            ...
            if (record.saveSign != 2) {
                ...
                e.cellHtml = '<a href="javascript:void(0)" onclick="saveSingleImportedAlarmInstance(\''
    ...
    function saveSingleImportedAlarmInstance(instanceName, unitName, protocolName, protocolDeviceType, saveSign, msg) {
        ...
        function doSave() {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (window.parent && window.parent.refreshAlarmInstanceList) {
                        window.parent.refreshAlarmInstanceList();
                    }
                },
                error: function () {
                    mini.unmask(document.body);
