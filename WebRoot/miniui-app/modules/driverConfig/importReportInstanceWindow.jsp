...
<div class="main-container">
    <div class="mini-toolbar">
        ...
        <form id="uploadForm"
              action="<%=context%>/acquisitionUnitManagerController/uploadImportedReportInstanceFile"
...
<script>
    ...
    function initI18n() {
        document.title = _loginUserLanguageResource.importReportInstance;
    ...
    function setData(data) {
        ...
        //var tree = mini.get('instanceTree');
        //if (tree) {
        //    tree.load(context + '/acquisitionUnitManagerController/getUploadedReportInstanceTreeData');
        //}
    }
    ...
    function onTreeLoad(e) {
        var tree = e.sender;
        tree.setColumns([
            { field: 'text', name: 'taskname', header: _loginUserLanguageResource.importReportInstance,
    ...
    function onTreeDrawcell(e) {
        ...
        if (field === 'msg' && record.classes == 1) {
            ...
            if (record.saveSign != 2) {
                ...
                e.cellHtml = '<a href="javascript:void(0)" onclick="saveSingleImportedReportInstance(\''
                    + instanceName + '\',\'' + unitName + '\',\'' + saveSign + '\',\'' + msg + '\')" '
    ...
    function saveSingleImportedReportInstance(instanceName, unitName, saveSign, msg) {
        ...
        function doSave() {
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (window.parent && window.parent.refreshReportInstanceList) {
                        window.parent.refreshReportInstanceList();
                    }
                },
                error: function () {
                    mini.unmask(document.body);
