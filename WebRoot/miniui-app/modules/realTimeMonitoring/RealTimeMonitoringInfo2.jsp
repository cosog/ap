            ...
            <div class="device-overview-area">
                ...
                <div class="grid-wrapper">
                    <div id="deviceGrid" class="mini-datagrid" style="width:100%;height:100%;"
                         idField="id" pageSize="50" allowResize="true"
...
function refreshDeviceTabs(selected) {
    ...
    if (showWellbore) {
        middleTabsConfig.push({
            ...
            title: _loginUserLanguageResource.wellboreAnalysis,
    ...
    if (showSurface) {
        middleTabsConfig.push({
            ...
            title: _loginUserLanguageResource.surfaceAnalysis,
            body: '<div class="loading-placeholder">加载中...</div>'
        });
    }
    if (showTrend) {
    ...
    if (showDynamic) {
    	middleTabsConfig.push({
            ...
            body: '<div style="display:flex; flex-direction:column; height:100%;">' +
                  '<div style="flex-shrink:0; padding:4px 8px; background:#f5f5f5; border-bottom:1px solid #ddd; display:flex; align-items:center; gap:6px;">' +
