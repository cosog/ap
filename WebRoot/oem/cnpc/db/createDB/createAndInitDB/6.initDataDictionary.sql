...
insert into TBL_DIST_NAME (SYSDATAID, TENANTID, NAME_ZH_CN, CODE, SORTS, STATUS, CREATOR, UPDATEUSER, UPDATETIME, CREATEDATE, MODULEID, NAME_EN, NAME_RU)
values ('1404100741bc42799be5b7cbebf4b649', null, '辅件设备_辅件设备列表', 'auxiliaryDeviceManager', 22105, 0, '超级管理员', '超级管理员', to_date('20-12-2024 09:42:42', 'dd-mm-yyyy hh24:mi:ss'), to_date('20-12-2024 09:42:42', 'dd-mm-yyyy hh24:mi:ss'), 34, 'auxiliaryDeviceManager', '辅件设备_辅件设备列表');
