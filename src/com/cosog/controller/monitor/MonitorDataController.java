...
import com.cosog.model.MonitorWaterInjectionWell;
...
//		HttpServletResponse response = ServletActionContext.getResponse();
	...
	public String exportExcelMonitorHistoryData() throws Exception {
		...
		String start_Date = "";
		String end_Date = "";
		String sql = "select to_char(Max(acqTime),'yyyy-mm-dd')   from tbl_rpc_diagram_hist t";
...
//		HttpServletResponse response = ServletActionContext.getResponse();
	...
	public String showMonitorHistoryData() throws Exception {
		...
		String start_Date = "";
		String end_Date = "";
		String sql = " select to_char(Max(acqTime),'yyyy-mm-dd')   from tbl_rpc_diagram_hist t where jsbz=1";
		List listd = this.commonDataService.reportDateJssj(sql);
