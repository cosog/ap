...
@Entity
@Table(name = "tbl_pcpdeviceaddinfo")
public class PCPDeviceAddInfo implements java.io.Serializable{
	...
	public PCPDeviceAddInfo() {
		super();
	}
	
	public PCPDeviceAddInfo(Integer id, Integer wellId, String itemName, String itemValue, String itemUnit) {
		super();
		this.id = id;
		this.wellId = wellId;
