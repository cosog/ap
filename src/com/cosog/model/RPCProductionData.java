...
public class RPCProductionData{
	...
	private Integer pumpGrade;
	private Integer pumpBoreDiameter;
	...
	public RPCProductionData() {
		super();
	}

	public RPCProductionData(Integer id, Integer wellId, String acqTime, Integer liftingType, Integer displacementType,
			...
			Double productionGasOilRatio, Double producingfluidLevel, Double pumpSettingDepth, String pumpType,
			String barrelType, Integer pumpGrade, Integer pumpBoreDiameter, Double plungerLength,
			Double tubingStringInsideDiameter, Double casingStringInsideDiameter, String rodGrade1,
	...
	public Integer getPumpGrade() {
		return pumpGrade;
	}

	public void setPumpGrade(Integer pumpGrade) {
		this.pumpGrade = pumpGrade;
	}

	public Integer getPumpBoreDiameter() {
		return pumpBoreDiameter;
	}

	public void setPumpBoreDiameter(Integer pumpBoreDiameter) {
		this.pumpBoreDiameter = pumpBoreDiameter;
	}

	public Double getPlungerLength() {
		return plungerLength;
	}

	public void setPlungerLength(Double plungerLength) {
		this.plungerLength = plungerLength;
	}
