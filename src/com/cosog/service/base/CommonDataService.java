...
//					String temp = columns[i];
	...
	public String findAlarmSetDataById(Page pager) {
		String sql = "";
		StringBuffer sqlwhere = new StringBuffer();
		sqlwhere.append("select t.id, w.resultcode,w.resultname, t.alarmtype,code1.itemname as alarmtypename, t.alarmlevel,code2.itemname as alarmlevelname,decode(t.alarmsign@1@'开'@'关') as alarmsign,t.remark");
