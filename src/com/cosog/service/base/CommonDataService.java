...
import com.cosog.utils.XmlParseToolsHandler;
...
public class CommonDataService extends BaseService {
	 ...
	 */
	public String showTableHeadersColumns(String ddicCode,String dictDeviceType,String language) {
		Map<String, Object> map = DataModelMap.getMapObject();// 获取一个map对象
		DataDictionary ddic = null;
		try {
			ddic = dataitemsInfoService.findTableSqlWhereByListFaceId(ddicCode,dictDeviceType,language);// 从字典表里获取字典数据信息
		} catch (Exception e) {
	 ...
	 * @throws IOException 
	 */
	public String findCommonModuleDataById(Page pager, String orgId, String ddicCode,String dictDeviceType, Vector<String> v,String language) throws IOException, SQLException {
		String sql = "";
		String sqlAll = "";
		int limit = 25;
		StringBuffer sqlwhere = new StringBuffer();
		...
		Map<String, Object> map = DataModelMap.getMapObject();// 获取一个map对象
		DataDictionary ddic  = dataitemsInfoService.findTableSqlWhereByListFaceId(ddicCode,dictDeviceType,language);// 从字典表里获取字典数据信息
...
//		}
	...
	public String findMonitorHistoryDataById(Page pager, String orgId, String ddicCode,String dictDeviceType, Vector<String> v,String language) throws IOException, SQLException {
		String sql = "";
		String sqlAll = "";
...
//		sqlCuswhere.append(" where rn >"+pager.getStart());
	...
	public String findCommonMuchHeadModuleDataById(Page pager, String ddicCode,String dictDeviceType, Vector<String> v,String language) throws IOException, SQLException {
		String sql = "";
		int limit = 25;
		StringBuffer sqlwhere = new StringBuffer();
		Map<String, Object> map = DataModelMap.getMapObject();// 获取一个map对象
	 ...
	 * @return
	 */
	public String findGridJsonDataByDdicCode(Page pager, String orgId, String ddicCode,String dictDeviceType, Vector<String> v,String language) {
		String sql = "";
		Map<String, Object> map = DataModelMap.getMapObject();
		DataDictionary ddic = null;
	 ...
	 * @return
	 */
	public String findGridJsonAllDataByDdicCode(Page pager, String orgId, String ddicCode,String dictDeviceType, Vector<String> v,String language) {
		String sql = "";
		Map<String, Object> map = DataModelMap.getMapObject();
		DataDictionary ddic = null;
		ddic = (DataDictionary) map.get(ddicCode);
	...
	public String findReportPumpUnitDataById(Page pager, String orgId,String dictDeviceType, Vector<String> v,String language) throws IOException, SQLException {
		String sql = "";
		int limit = 25;
		StringBuffer sqlwhere = new StringBuffer();
		Map<String, Object> map = DataModelMap.getMapObject();
		...
		if (ddic == null || "".equals(ddic)) {
			ddic = dataitemsInfoService.findTableSqlWhereByListFaceId("pumpUnitDayReport",dictDeviceType,language);
	...
	public String exportDataExcel(HttpServletResponse response, String fileName, String title, Vector<String> imageUrl, String head, String field, String orgId, String ddicCode,String dictDeviceType, Vector<String> v,String language) throws Exception {
		...
		if (ddic == null || "".equals(ddic)) {
			ddic = dataitemsInfoService.findTableSqlWhereByListFaceId(tabNameString,dictDeviceType,language);
	...
	public String exportDataWellExcel(HttpServletResponse response, String fileName, String title, Vector<String> imageUrl, String head, String field, String orgId, String ddicCode,String dictDeviceType, Vector<String> v,String language) throws Exception {
		OutputStream os = response.getOutputStream();//
		response.reset();
		response.setContentType("application/vnd.ms-excel");// 设置生成的文件类型
		imageUrl = null;
	...
	public boolean exportReportPumpunitCustomDataExcel(HttpServletResponse response, String fileName, String title,String dictDeviceType, Vector<String> imageUrl, String head, String field, String orgId, DataModels data, Vector<String> v,String language) {
