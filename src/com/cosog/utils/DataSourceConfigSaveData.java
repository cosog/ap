...
public class DataSourceConfigSaveData {
	...
	private String Code;
	 ...
	 private DataSourceConfig.DiagramTable DiagramTable;
	 private DataSourceConfig.ReservoirTable ReservoirTable;
	 private DataSourceConfig.RodStringTable RodStringTable;
	 private DataSourceConfig.TubingStringTable TubingStringTable;
	 private DataSourceConfig.CasingStringTable CasingStringTable;
	 private DataSourceConfig.PumpTable PumpTable;
	 private DataSourceConfig.ProductionTable ProductionTable;
...
//	}
	...
	public DataSourceConfig.DiagramTable getDiagramTable() {
		return DiagramTable;
	}

	public void setDiagramTable(DataSourceConfig.DiagramTable diagramTable) {
		DiagramTable = diagramTable;
	}

	public DataSourceConfig.ReservoirTable getReservoirTable() {
		return ReservoirTable;
	}

	public void setReservoirTable(DataSourceConfig.ReservoirTable reservoirTable) {
		ReservoirTable = reservoirTable;
	}

	public DataSourceConfig.RodStringTable getRodStringTable() {
		return RodStringTable;
	}

	public void setRodStringTable(DataSourceConfig.RodStringTable rodStringTable) {
		RodStringTable = rodStringTable;
	}

	public DataSourceConfig.TubingStringTable getTubingStringTable() {
		return TubingStringTable;
	}

	public void setTubingStringTable(DataSourceConfig.TubingStringTable tubingStringrTable) {
		TubingStringTable = tubingStringrTable;
	}

	public DataSourceConfig.CasingStringTable getCasingStringTable() {
		return CasingStringTable;
	}

	public void setCasingStringTable(DataSourceConfig.CasingStringTable casingStringTable) {
		CasingStringTable = casingStringTable;
	}

	public DataSourceConfig.PumpTable getPumpTable() {
		return PumpTable;
	}

	public void setPumpTable(DataSourceConfig.PumpTable pumpTable) {
		PumpTable = pumpTable;
	}

	public DataSourceConfig.ProductionTable getProductionTable() {
		return ProductionTable;
	}

	public void setProductionTable(DataSourceConfig.ProductionTable productionTable) {
