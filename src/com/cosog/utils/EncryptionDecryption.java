...
public class EncryptionDecryption {
	...
	private static String strDefaultKey = "-+?!asxdc";
	 ...
	 * @throws Exception
	 */
	public static String getEncrypt(String pwd) throws Exception {
		EncryptionDecryption decryption = new EncryptionDecryption(
				strDefaultKey);// 自定义密钥
		String encryptpwd = decryption.encrypt(pwd);
		return encryptpwd;
	}
	 ...
	 * @throws Exception
	 */
	public static String getDecrypt(String pwd) throws Exception {
		EncryptionDecryption decryption = new EncryptionDecryption(
				strDefaultKey);// 自定义密钥
		String decryptpwd = decryption.decrypt(pwd);
		return decryptpwd;
	}
