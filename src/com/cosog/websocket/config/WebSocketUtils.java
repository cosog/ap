...
public class WebSocketUtils {
	public Logger logger = LoggerFactory.getLogger(WebSocketUtils.class);
	public static int onlineCount = 0; 
	public String userId;
	public Session session; 
    public static final ConcurrentHashMap<String, WebSocketUtils> clients;
    
    static {
    	clients =  new ConcurrentHashMap<String, WebSocketUtils>();
    }
    //连接时执行
    @OnOpen
