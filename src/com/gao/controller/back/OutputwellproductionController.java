...
import com.gao.service.back.OutputwellproductionService;
...
public class OutputwellproductionController extends BaseController {
	 ...
	 */
	@RequestMapping("/doOutputwellproductionAdd")
	public String doOutputwellproductionAdd() throws IOException {
		String result = "";
		PrintWriter out = response.getWriter();
		try {
			this.outputwellproductionService
					.saveOrUpdateorDeleteProOutputwellproduction(
							outputwellproduction, "no", "add");
			result = "{success:true,msg:true}";
			response.setCharacterEncoding(Constants.ENCODING_UTF8);
			out.print(result);
		} catch (Exception e) {
	...
	@RequestMapping("/doOutputwellproductionBulkDelete")
	public String doOutputwellproductionBulkDelete() {
		try {
			outputwellproduction = new Outputwellproduction();
			String OutputwellproductionIds = ParamUtils.getParameter(request,"paramsId");
			outputwellproduction.setJlbh(0);
			outputwellproduction.setJbh(0);
			outputwellproduction.setRcyl(0.00);
			outputwellproduction.setCjsj(null);
			if (OutputwellproductionIds != null
					|| OutputwellproductionIds != "") {

				this.outputwellproductionService
						.saveOrUpdateorDeleteProOutputwellproduction(
								outputwellproduction, OutputwellproductionIds,
								"delete");
			}
			response.setCharacterEncoding(Constants.ENCODING_UTF8);
	...
	@RequestMapping("/doOutputwellproductionEdit")
	public String doOutputwellproductionEdit() {
		try {
			this.outputwellproductionService
					.saveOrUpdateorDeleteProOutputwellproduction(
							outputwellproduction, "no", "modify");
			response.setCharacterEncoding(Constants.ENCODING_UTF8);
			response.setHeader("Cache-Control", "no-cache");
			PrintWriter pw = response.getWriter();
