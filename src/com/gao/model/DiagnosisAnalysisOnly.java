...
public class DiagnosisAnalysisOnly implements java.io.Serializable {
	...
	private Double sijzdzh=0.0;// 四级最大载荷(kN)
	private Double sijzxzh=0.0;// 四级最小载荷(kN)
	private Double sijzdyl=0.0;// 四级最大应力(MPa)
	private Double sijzxyl=0.0;// 四级最小应力(MPa)
	private Double sijxyyl=0.0;// 四级许用应力(MPa)
	private Double sijylbfb=0.0;// 四级应力百分比(%)
	...
	@Column(name = "SIJZDZH", precision = 8)
	public Double getSijzdzh() {
		return sijzdzh;
	}

	public void setSijzdzh(Double sijzdzh) {
		this.sijzdzh = sijzdzh;
	}

	@Column(name = "SIJZXZH", precision = 8)
	public Double getSijzxzh() {
		return sijzxzh;
	}

	public void setSijzxzh(Double sijzxzh) {
		this.sijzxzh = sijzxzh;
	}

	@Column(name = "SIJZDYL", precision = 8)
	public Double getSijzdyl() {
		return sijzdyl;
	}

	public void setSijzdyl(Double sijzdyl) {
		this.sijzdyl = sijzdyl;
	}

	@Column(name = "SIJZXYL", precision = 8)
	public Double getSijzxyl() {
		return sijzxyl;
	}

	public void setSijzxyl(Double sijzxyl) {
		this.sijzxyl = sijzxyl;
	}

	@Column(name = "SIJXYYL", precision = 8)
	public Double getSijxyyl() {
		return sijxyyl;
	}

	public void setSijxyyl(Double sijxyyl) {
		this.sijxyyl = sijxyyl;
	}

	@Column(name = "SIJYLBFB", precision = 8)
	public Double getSijylbfb() {
		return sijylbfb;
	}

	public void setSijylbfb(Double sijylbfb) {
		this.sijylbfb = sijylbfb;
	}
