...
import com.gao.model.calculate.RPCCalculateRequestData.EveryRod;
import com.gao.model.calculate.RPCCalculateRequestData.EveryTubing;
public class PCPCalculateRequestData {
	...
	public PCPCalculateRequestData(String aKString, String WellName,
			com.gao.model.calculate.PCPCalculateRequestData.FluidPVT fluidPVT,
			com.gao.model.calculate.PCPCalculateRequestData.Reservoir reservoir,
			com.gao.model.calculate.PCPCalculateRequestData.WellboreTrajectory wellboreTrajectory,
			com.gao.model.calculate.PCPCalculateRequestData.RodString rodString,
			com.gao.model.calculate.PCPCalculateRequestData.TubingString tubingString,
			com.gao.model.calculate.PCPCalculateRequestData.Pump pump,
			com.gao.model.calculate.PCPCalculateRequestData.TailTubingString tailTubingString,
			com.gao.model.calculate.PCPCalculateRequestData.CasingString casingString,
			com.gao.model.calculate.PCPCalculateRequestData.Production production,
			com.gao.model.calculate.PCPCalculateRequestData.SystemEfficiency systemEfficiency,
			com.gao.model.calculate.PCPCalculateRequestData.ManualIntervention manualIntervention) {
		super();
		AKString = aKString;
