...
public class ProductionOutGridPanelData {
	private int jlbh;
	private String jh;
	private String jslxName;
	private String qtlxName;
	private String sfpfclName;
	private String ccjztName;
	private double hsl;
	private double yy;
	private double ty;
	private double hy;
	...
	private double yjgj;
	private String yjgjb="C";
	private double yjgcd;
	private double ejgj;
	private String ejgjb="C";
	private double ejgcd;
	private double sjgj;
	private String sjgjb="C";
	private double sjgcd;
	private double sijgj;
	private String sijgjb="C";
	private double sijgcd;
	public double getSijgj() {
		return sijgj;
	}

	public void setSijgj(double sijgj) {
		this.sijgj = sijgj;
	}
	...
	public double getSijgcd() {
		return sijgcd;
	}

	public void setSijgcd(double sijgcd) {
		this.sijgcd = sijgcd;
	}



	private String mdztName;
	private float jmb;
	private int bzgtbh;
	private int bzdntbh;
	private int jslx;
	...
	public ProductionOutGridPanelData() {
		super();
	}
	
	public ProductionOutGridPanelData(int jlbh, String jh, String jslxName, String qtlxName, String sfpfclName,
			String ccjztName, double hsl, double yy, double ty, double hy, double dym, double bg, double jklw,
			double scqyb, double bj, String blxName, String bjbName, double zsc, String blx, String btlxName,
			double ygnj, double yctgnj, double yjgj, String yjgjb, double yjgcd, double ejgj, String ejgjb,
			double ejgcd, double sjgj, String sjgjb, double sjgcd, String mdztName, float jmb, int bzgtbh, int bzdntbh,
			int jslx, int qtlx, int sfpfcl, int ccjzt, int rcql, int bjb, int mdzt, String threadid, String cjsj) {
		super();
		this.jlbh = jlbh;
		this.jh = jh;
		this.jslxName = jslxName;
		this.qtlxName = qtlxName;
		this.sfpfclName = sfpfclName;
		this.ccjztName = ccjztName;
		this.hsl = hsl;
		this.yy = yy;
		this.ty = ty;
		this.hy = hy;
	...
	public String getQtlxName() {
		return qtlxName;
	}

	public void setQtlxName(String qtlxName) {
		this.qtlxName = qtlxName;
	}

	public String getSfpfclName() {
		return sfpfclName;
	}

	public void setSfpfclName(String sfpfclName) {
		this.sfpfclName = sfpfclName;
	}

	public String getCcjztName() {
		return ccjztName;
	}

	public void setCcjztName(String ccjztName) {
		this.ccjztName = ccjztName;
	}
	...
	public String getMdztName() {
		return mdztName;
	}

	public void setMdztName(String mdztName) {
		this.mdztName = mdztName;
	}
	...
	public void setJmb(float jmb) {
		this.jmb = jmb;
	}

	public int getBzgtbh() {
		return bzgtbh;
	}

	public void setBzgtbh(int bzgtbh) {
		this.bzgtbh = bzgtbh;
	}

	public int getBzdntbh() {
		return bzdntbh;
	}

	public void setBzdntbh(int bzdntbh) {
		this.bzdntbh = bzdntbh;
	}
	...
	public void setQtlx(int qtlx) {
		this.qtlx = qtlx;
	}

	public int getSfpfcl() {
		return sfpfcl;
	}

	public void setSfpfcl(int sfpfcl) {
		this.sfpfcl = sfpfcl;
	}
	...
	public void setCcjzt(int ccjzt) {
		this.ccjzt = ccjzt;
	}
