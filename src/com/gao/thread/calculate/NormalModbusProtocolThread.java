...
public class NormalModbusProtocolThread extends ProtocolBasicThread{
	...
	public NormalModbusProtocolThread(int threadId, ClientUnit clientUnit,RTUDriveConfig driveConfig) {
		super();
